    ...
    <div class="wl-app-shell">
        <header class="wl-topbar">
            <div class="wl-topbar__brand">
                ...
                <div>
                    ...
                    <div class="wl-topbar__subtitle">{{ config('app.name') ?: 'Workflow Operations' }}</div>
                </div>
            </div>
            ...
            <div class="wl-topbar__actions">
                ...
                <button class="wl-topbar__button" v-on:click.prevent="toggleTheme" :title="theme === 'light' ? 'Switch to Dark Mode' : 'Switch to Light Mode'">
        ...
        <div class="wl-shell">
            <aside class="wl-sidebar" aria-label="Waterline navigation">
                ...
                <nav class="wl-sidebar__nav">
                    <router-link active-class="active" to="/running" class="wl-sidebar__link">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                            <path d="M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zm12.73-1.41A8 8 0 1 0 4.34 4.34a8 8 0 0 0 11.32 11.32zM7 6h2v8H7V6zm4 0h2v8h-2V6z"></path>
                        </svg>
                        <span>Running</span>
                    </router-link>

                    <router-link active-class="active" to="/completed" class="wl-sidebar__link">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <router-link active-class="active" to="/failed" class="wl-sidebar__link">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <router-link active-class="active" to="/cancelled" class="wl-sidebar__link">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <router-link active-class="active" to="/terminated" class="wl-sidebar__link">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
