...
docker run --rm -p 8080:8080 \
  ...
  durableworkflow/waterline:2.0.0-beta.13
```
...
```bash
composer require \
  durable-workflow/waterline:2.0.0-beta.13@beta \
  durable-workflow/workflow:2.0.0-beta.13@beta \
  durable-workflow/sdk:2.0.0-beta.13@beta
