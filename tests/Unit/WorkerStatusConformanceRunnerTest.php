...
final class WorkerStatusConformanceRunnerTest extends TestCase
{
    ...
    public function testPublishedWorkerExecutionUsesThePhpSdkPackageBoundary(): void
    {
        ...
        $this->assertSame('2.0.0-beta.14', $manifest['extra']['durable-workflow']['product-train'] ?? null);
        $this->assertSame('2.0.0-beta.14', $manifest['require-dev']['durable-workflow/workflow'] ?? null);
        $this->assertSame('2.0.0-beta.14', $manifest['require']['durable-workflow/sdk'] ?? null);
