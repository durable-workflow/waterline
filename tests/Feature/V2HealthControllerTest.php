...
class V2HealthControllerTest extends TestCase
{
    ...
    public function testHealthEndpointCategorizesEveryCheckAndExposesWakeAcceleration(): void
    {
        ...
        $this->assertCount(1, $routingChecks, 'Waterline health must surface the routing_health check so operators can read routing-drain risk on the workers surface.');
